...
class Actions extends React.Component{
    ...
    // UPDATE USER
    handleUpdate = (id,first_name,last_name,user_email) => {
    ...
    // INSERT USER
    insertUser = (event,first_name,last_name,user_email) => {
        ...
        .then(function ({data}) {
            if(data.success === 1){
                this.setState({
                    users:[
                        {"id":data.id,"first_name":first_name,"last_name":last_name ,"user_email":user_email},
                        ...this.state.users
                    ]
                });
                event.target.reset();
